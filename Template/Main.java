...
public class Main {
    ...
    public static void main(String[] args) {
        // out.preCompute(false, false, false, false, true, out.E7, MOD);
        int t = 1;
    ...
    static class Mix {
        ...
        public void preCompute(boolean primes, boolean primesList, boolean factorials, boolean inverseFactorials,
            ...
            if (factorials)
                factorials(n, mod);
            if (inverseFactorials)
                inverseFactorials(n, mod);
            if (power2) {
                buildPower2(n, mod);
            }
        }

        public void buildPower2(int n, long mod) {
            power2 = new long[n + 1];
            power2[0] = 1;
            for (int i = 1; i <= n; i++) {
        ...
        // Print element
        public Mix print(String x) {
            res.append(x);
            return out;
        }

        public Mix print(int x) {
            res.append(x);
            return out;
        }

        public Mix print(long x) {
            res.append(x);
            return out;
        }

        public Mix print(char x) {
            res.append(x);
            return out;
        }

        // Print element with new line
        public Mix println(String x) {
            res.append(x).append("\n");
            return out;
        }

        public Mix println(int x) {
            res.append(x).append("\n");
            return out;
        }

        public Mix println(long x) {
            res.append(x).append("\n");
            return out;
        }

        public Mix println(char x) {
            res.append(x).append("\n");
            return out;
        }
        ...
        public char intToLowerChar(int ind) {
            return (char) (ind + 'a');
        }

        public char intToUpperChar(int ind) {
            return (char) (ind + 'A');
        }
        ...
        public long modSubtract(long x, long y, long MOD) {
